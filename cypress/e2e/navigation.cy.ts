describe("Sidebar Navigation", () => {
  ...
  context("desktop resolution", () => {
    ...
    it("Support button should open the user’s mail app", () => {
      // collapse navigation
  ...
  context("mobile resolution", () => {
    ...
    it("toggles sidebar navigation by clicking the menu icon", () => {
      ...
      cy.get("button.button_button.menu-item-link_anchor").should("not.exist");
      // cy.get("nav").contains("Collapse").should("not.exist");
